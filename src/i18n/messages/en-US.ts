...
export const enUS = {
  ...
  'app.brand.caption': 'A journey of presence',
  'app.start.state': 'New journey',
  ...
  'app.start.pointerHint': 'Click to capture the mouse',
  'app.enter': 'Enter the world',
  'app.resume': 'Continue journey',
  'app.journey.eyebrow': 'Your journey',
  'app.journey.progress': '2 regions available',
  'app.journey.current': 'Available now',
  'app.journey.available': 'Available',
  'app.journey.future': 'Coming soon',
  ...
  'lab.creationActivity.pause': 'Simulate inactivity',
  'lab.creationActivity.resume': 'Resume activity',
