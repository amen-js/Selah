...
export const esES = {
  ...
  'app.brand.caption': 'Un viaje de presencia',
  'app.start.state': 'Nuevo viaje',
  'app.paused.state': 'En pausa',
  ...
  'app.start.pointerHint': 'Haz clic para capturar el ratón',
  'app.enter': 'Entrar al mundo',
  'app.resume': 'Continuar el viaje',
  'app.journey.eyebrow': 'Tu viaje',
  'app.journey.progress': '2 regiones disponibles',
  'app.journey.current': 'Disponible ahora',
  'app.journey.available': 'Disponible',
  'app.journey.future': 'Próximamente',
